export default function CottonVendingMachine() {
  return (
    <>
      ...
      <div className="row my-3">
        ...
        <div className="col-md-6 col-12">
          <ul className="mt-3">
            ...
            <li>
              24 小時自動運營 <br />
              24hr Automatic Operation
            </li>
            <li>
              大面積觸摸屏 <br /> Large touch screen
            </li>
            <li>
              冬季不凍結 <br /> No condensation outdoors in winter
            </li>
          </ul>
      ...
      <img
        src="https://github.com/dotku/dkwholesale.us/assets/1519232/9ca1eef6-d6d9-4144-9093-03ea01487b8d"
        alt="Cotton Vending Machine, lady aside"
        className="img-fluid rounded"
      />
      <center>
        <video
